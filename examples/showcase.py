...
data = [
    {"id": 1, "name": {"first": "Thor", "last": "Odinson"}, "age": 1500, "sex": "M", "family": "Avengers", "score": 95, "active": True},
    {"id": 2, "name": {"first": "Loki", "last": "Odinson"}, "age": 1054, "sex": "M", "family": "Avengers", "score": 78, "active": False},
    {"id": 3, "name": {"first": "Thanos", "last": None}, "age": 1000, "sex": "M", "family": "Avengers", "score": 99, "active": False},
    {"id": 4, "name": {"first": "Ironman", "last": None}, "age": 45, "sex": "M", "family": "Avengers", "score": 88, "active": True},
    {"id": 5, "name": {"first": "Eleven", "last": None}, "age": 14, "sex": "F", "family": "StrangerThings", "score": 92, "active": True},
    {"id": 6, "name": {"first": "Joey", "last": None}, "age": 35, "sex": "M", "family": "Friends", "score": 65, "active": True},
    {"id": 7, "name": {"first": "Rachel", "last": "Green"}, "age": 30, "sex": "F", "family": "Friends", "score": 82, "active": True},
    {"id": 8, "name": {"first": "Chandler", "last": "Bing"}, "age": 32, "sex": "M", "family": "Friends", "score": 75, "active": True},
]
...
def showcase_data_manipulation():
    ...
    print("\nWith full names:")
    with_full_names = query.apply(lambda x: {
        **x, 
...
def showcase_complex_queries():
    ...
    for perf in family_performance:
        print(f"  {perf['family']}: {perf['active_members']}/{perf['total_members']} active, "
